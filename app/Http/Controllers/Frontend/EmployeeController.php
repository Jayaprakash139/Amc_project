...
class EmployeeController extends Controller
{
    ...
    public function index()
    {
        ...
        $employees = Employee::with(['department', 'team'])->get();
    ...
    public function create()
    {
        ...
        return view('frontend.employees.create', compact('departments'));
    }
    ...
    public function edit(Employee $employee)
    {
        ...
        return view('frontend.employees.edit', compact('departments', 'employee'));
    }
