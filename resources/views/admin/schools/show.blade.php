...
<div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
        <li class="nav-item">
            <a class="nav-link" href="#school_allocations" role="tab" data-toggle="tab">
                {{ trans('cruds.allocation.title') }}
            </a>
        </li>
    </ul>
    <div class="tab-content">
        <div class="tab-pane" role="tabpanel" id="school_allocations">
            @includeIf('admin.schools.relationships.schoolAllocations', ['allocations' => $school->schoolAllocations])
        </div>
    </div>
</div>
