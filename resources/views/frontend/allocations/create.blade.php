...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("frontend.allocations.store") }}" enctype="multipart/form-data">
            @csrf
...
$(document).ready(function () {
    $('#school_id').change(function () {
        ...
        $.ajax({
            url: '{{ route("frontend.get-location", ":schoolId") }}'.replace(':schoolId', schoolId),
            type: 'GET',
